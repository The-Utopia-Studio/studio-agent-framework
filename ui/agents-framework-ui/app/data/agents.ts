...
export const AGENT_BLUEPRINTS: Record<string, AgentBlueprint> = {
  ...
  PROJECT: {
    ...
    status: 'READY',
    summary: 'A standing workspace combines instructions, approved references, and reviewed notes without a custom runtime.',
    nodes: [
      { id: 'trigger', label: 'Analyst request', kind: 'trigger' },
      { id: 'agent', label: 'Research workspace', kind: 'agent' },
      { id: 'output', label: 'Analyst review', kind: 'output' },
      { id: 'instructions', label: 'instructions.md', kind: 'file' },
      { id: 'references', label: 'references.md', kind: 'file' },
      { id: 'notes', label: 'reviewed-notes.md', kind: 'file' },
      { id: 'search', label: 'Web search', kind: 'tool' },
      { id: 'notion', label: 'Notion', kind: 'tool' },
      { id: 'claude', label: 'Claude', kind: 'tool' },
    ],
    edges: [
      ['trigger', 'agent'], ['agent', 'output'], ['agent', 'instructions'],
      ['agent', 'references'], ['agent', 'notes'], ['references', 'search'],
      ['notes', 'notion'], ['instructions', 'claude'],
    ],
    buildTools: ['claude'],
    harness: { id: 'claude', label: 'Claude', detail: 'Standing project instructions' },
  },
  'MANAGED SURFACE': {
