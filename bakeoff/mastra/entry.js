...
function makeMastra(dbPath) {
  ...
  const m = new Mastra({
    ...
    // Mastra's OWN store. Coexists with our event log and is never authoritative;
    // the probes never query it (PRD §5, Open Question 1).
    storage: new LibSQLStore({ id: 'mastra-native', url: `file:${dbPath}.mastra.db` }),
